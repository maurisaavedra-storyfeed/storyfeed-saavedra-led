...
var getMenuItemsMobile = function () {
  var defaultItems = Telescope.menuItems.get("viewsMenuMobile");
...
Template.custom_views_menu_mobile.helpers({
  menuLabel: function () {
    return i18n.t("view");
  },
  menuItems: function () {
    return getMenuItemsMobile();
  }
});
